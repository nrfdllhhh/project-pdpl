...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('assets/asset/lib/animate/animate.min.css')}}" rel="stylesheet">
        <link href="{{asset('assets/asset/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
        <link href="{{asset('assets/asset/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="{{asset('assets/asset/css/bootstrap.min.css')}}" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="{{asset('assets/asset/css/style.css')}}" rel="stylesheet">
    </head>
    ...
    <script src="{{asset('assets/asset/lib/wow/wow.min.js')}}"></script>
    <script src="{{asset('assets/asset/lib/easing/easing.min.js')}}"></script>
    <script src="{{asset('assets/asset/lib/waypoints/waypoints.min.js')}}"></script>
    <script src="{{asset('assets/asset/lib/counterup/counterup.min.js')}}"></script>
    <script src="{{asset('assets/asset/lib/owlcarousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('assets/asset/lib/lightbox/js/lightbox.min.js')}}"></script>
